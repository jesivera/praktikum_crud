...
{   
   ...
   $nama_alat= $_POST['nama_alat'];
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE alat SET nama_alat='$nama_alat',tahun='$tahun',merek='$merek',lokasi='$lokasi',status_kalibrasi='$status_kalibrasi' WHERE id=$id");
...
while($user_data = mysqli_fetch_array($result))
{
    ...
    $status_kalibrasi = $user_data['status_kalibrasi'];
}
?>
<html>
<head>  
...
<body>
    ...
    <form name="update_user" method="post" action="edit.php">
        <table border="0">
            ...
            <tr> 
                <td>status_kalibrasi</td>
                <td><input type="text" name="status_kalibrasi" value=<?php echo $status_kalibrasi;?>></td>
            </tr>
            <tr>
