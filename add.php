...
<p>Belajar Pemrograman Web</p>
    <form action="add.php" method="post" name="form1">
        <table width="25%" border="0">
            ...
            <tr> 
                ...
                <td><input type="text" name="status_kalibrasi"></td>
            </tr>
            <tr>
                <td></td>
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO alat(nama_alat,tahun,merek,lokasi,status_kalibrasi) VALUES('$nama_alat','$tahun','$merek','$lokasi','$status_kalibrasi')");
